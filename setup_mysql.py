#!/usr/bin/env python3
"""
Setup MySQL Database for NepSewa
Run this script to initialize MySQL database with comprehensive provider data
"""

import mysql.connector
from mysql_config import MYSQL_CONFIG

def setup_mysql_with_data():
    """Setup MySQL database with comprehensive provider data"""
    try:
        # Connect to MySQL
        ...
        # Add comprehensive provider data (15+ per service)
        providers = [
        ...
        print(f"✅ MySQL database setup complete with {final_count} providers!")
        print("🚀 You can now start your server with: python run_local.py")
